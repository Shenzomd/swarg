...
TOKEN = '6578176552:AAFdarsUZC_aDzljhEmljXAZ4HoMHa29MiM'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -4219701404
CHANNEL_ID = -4219701404
error_channel_id = -4219701404
...
def handle_message(message):
    ...
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/+r1cor0uWupVlYTY1", parse_mode='Markdown')
